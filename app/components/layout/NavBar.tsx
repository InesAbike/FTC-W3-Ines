              ...
              {isLanguageDropdownOpen && (
                <div className="absolute right-0 mt-2 w-32 bg-white rounded-md shadow-lg border border-neutral-20 py-1 z-50">
                  <button
                    ...
                    className={`flex items-center space-x-2 px-3 py-2 text-sm w-full text-left hover:bg-neutral-10 transition-colors ${currency === 'VND' ? 'bg-neutral-10 text-primary' : 'text-neutral-80'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex items-center space-x-2 px-3 py-2 text-sm w-full text-left hover:bg-neutral-10 transition-colors ${currency === 'USD' ? 'bg-neutral-10 text-primary' : 'text-neutral-80'
                      }`}
                  >
                    <span className="text-xs">🇺🇸</span>
                    <span>USD</span>
                  ...
                  <button
                    ...
                    className={`flex items-center space-x-2 px-3 py-2 text-sm w-full text-left hover:bg-neutral-10 transition-colors ${currency === 'EUR' ? 'bg-neutral-10 text-primary' : 'text-neutral-80'
                      }`}
                  >
                    <span className="text-xs">🇪🇺</span>
                    <span>EUR</span>
