          ...
          <div className="hidden lg:flex items-center flex-1 max-w-md mx-8">
            <div className="relative w-full">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 rounded-full bg-white text-neutral-80 placeholder:text-neutral-40 focus:outline-none focus:ring-1 focus:ring-primary-dark-blue/20 focus:border-transparent text-sm"
              />
            </div>
          </div>
            ...
            <div className="relative lg:block hidden">
              ...
              {isLanguageDropdownOpen && (
                <div className="absolute right-0 mt-2 w-32 bg-white rounded-md shadow-lg border border-neutral-20 py-1 z-50">
                  <Link href="#" className="flex items-center space-x-2 px-3 py-2 text-sm text-neutral-80 hover:bg-neutral-10">
